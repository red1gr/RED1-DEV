Config = {
    ...
    Billing = 'rd-billing', -- 'okokBilling' / 'esx_billing' / 'jaksam_billing'
    TextUI = 'rd-textui', -- 'ox_lib' / 'rd-textui' / 'ESXTextUI' / 'QBDrawText' // Custom can be add in the cl_utils.lua!!!
    ProgressBar = 'pogressBar', -- 'progressBars' / 'pogressBar' / 'mythic_progbar' // Custom can be add in the cl_utils.lua!!!
    Inventory = 'quasar_inventory', -- 'ox_inventory' / 'qb_inventory' / 'quasar_inventory' / 'chezza_inventory' // Custom can be add in the cl_utils.lua!!!
    Metric = 'kmh', -- 'kmh' / 'mph'
    ...
    PoliceStations = {
        ...
        ['Police Department'] = {
            Job = 'police', -- Job name
            MenuColors = {'rgb(255, 0, 0)', 'rgb(255, 0, 0)'}, -- Job panel color

            Blip = {color = 38, sprite = 60, size = 1.0}, -- Job blip
            Marker = {use = true, marker = 20, rgb = {255, 0, 0}, bobUpAndDown = true, rotate = false},
            
            Duty = vector3(440.4164, -982.6036, 30.6893), -- Duty ON / OFF coords
            DutyBlips = false, -- With this the cops can see the other cops in the map.

            Cloakrooms = {
                vector3(457.5350, -993.3062, 30.6893),
                -- You can add more...
            },

            Armorys = {
                vector3(458.4433, -979.1313, 30.6893),
                vector3(459.9708, -983.0879, 30.6893),
            },

            BossMenu = {
                grades = {12},
                coords = {
                    vector3(463.9565, -1009.3844, 35.9311),-- 447.4103, -972.8533, 30.6893, 158.4043
                    vector3(447.4103, -972.8533, 30.6893),
                    -- You can add more...
                }
            },
            ...
            Garages = {
                {
                    ...
                    menu = vector3(457.7561, -1012.4355, 28.3186), -- Garage menu open coords
            ...
            Shop = {
                --
                {item = 'finger_scanner', label = 'Scanner', price = 500, minGrade = 0},
                {item = 'ifaks', label = 'ifaks', price = 500, minGrade = 0},
