                                ...
                                if not isBusy then
                                    QBCore.Functions.TriggerCallback('qb-powerplant:server:getCops', function(cops)
                                        if cops >= Config.MinCops.Fleeca then
                                            ...
                                            QBCore.Functions.Progressbar("hack_gate", "Connecting the laptop..", math.random(60000, 60000), false, true, {
                                                ...
                                                -- Remove Use
                                                TriggerServerEvent('qb-logs:server:createLog', 'simtopacific', 'Player Started Fleeca Robbery', "", source)
