...
Config.Banks = {
    ...
    ['Paleto'] = {
        ...
        thermite = {
            [1] = {
                ...
                doorId = 9, -- Door at: vector3(-106.08, 6475.3, 31.63) | 'paletothermite' for nui_doorlock
                hit = false
            }
        }
    },
    ...
    --     hacked = false,
    --     card = false,
    --     cardDoor = 322, -- Door at: 261.89, 221.88, 106.28 - 'pacificgoldcard' for nui_doorlock
    --     policeClose = false,
    --     object = 961976194,
    --     heading = {
    --         closed = 160.00,
    ...
    --             doorId = 321, -- Door at Location: 256.96, 220.38, 106.29 - 'pacificthermite1' for nui_doorlock
    --             hit = false
    --         },
    --         [2] = {
    --             coords = vector4(253.01703, 220.73141, 101.78381, 162.6746),
    --             ptfx = vector3(253.11703, 221.53141, 101.78381),
    --             doorId = 324, -- Door at location: 252.6, 221.14, 101.68 - 'pacificthermite2' for nui_doorlock
    --             hit = false
    --         },
    --         [3] = {
    --             coords = vector4(261.66752, 215.73648, 101.78382, 261.99899),
    --             ptfx = vector3(261.69946, 216.82735, 101.78382),
    --             doorId = 325, -- Door at location: 261.17, 215.28, 101.68 - 'pacificthermite3' for nui_doorlock
    --             hit = false
    --         }
    --     }
    -- },
    ['Vault'] = {
        ...
        explosion = {
            ...
            [6] = vector4(252.79, 221.15, 101.68, 160.42),
            [7] = vector4(261.12, 215.16, 101.68, 251.42)
        }
    }
}

Config.Bankrobbery = true
Config.Artgallery = false
...
-- Change this if you are running a custom clothing pock (very likely); True for no gloves
