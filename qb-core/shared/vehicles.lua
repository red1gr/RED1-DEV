...
local Vehicles = {
    ...
    { model = 'rd_car_01',          name = 'rd_car_01',                        brand = 'rd_car_01',           price = 13000,   category = 'compacts',       type = 'automobile', shop = 'pdm' },
    { model = 'rd_car_02',          name = 'rd_car_02',                        brand = 'rd_car_02',          price = 20000,   category = 'compacts',       type = 'automobile', shop = 'pdm' },
